...
log_level = 'INFO'
work_dir = './work_dirs/1geAttention_weight_pooling_dv_mvx'
...
load_from='/root/autodl-tmp/GuPao/MMDetection3d/mmdetection3d-master/work_dirs/Attention_weight_pooling_dv_mvx/epoch_149.pth'
resume_from = None
workflow = [('train', 1)]
