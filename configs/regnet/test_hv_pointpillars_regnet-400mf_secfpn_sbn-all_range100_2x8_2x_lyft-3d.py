...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            sizes=[[4.75, 1.92, 1.71], [10.24, 2.84, 3.44], [12.7, 2.92, 3.42],
                   [6.52, 2.42, 2.34], [8.17, 2.75, 3.2], [2.35, 0.96, 1.59],
                   [1.76, 0.63, 1.44], [0.8, 0.76, 1.76], [0.73, 0.35, 0.5]],
            rotations=[0, 1.57],
            reshape_out=True),
...
log_level = 'INFO'
work_dir = './work_dirs/hv_pointpillars_regnet-400mf_secfpn_sbn-all_range100_2x8_2x_lyft-3d'
load_from = None
resume_from = None
workflow = [('train', 1)]
