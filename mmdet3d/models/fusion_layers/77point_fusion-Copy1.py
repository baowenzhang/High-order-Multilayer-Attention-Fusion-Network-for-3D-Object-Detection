...
#         print("fuse_out_init权重：",fuse_out_init.size())
        fuse_out_init=fuse_out_init.view(-1,2,8,8)
        fuse_out_conv=self.conv_fusion(fuse_out_init)#(2,8,8)
...
#         print("conv_wei权重：",fuse_out_conv_wei.size())
        fuse_out_att=fuse_out_conv_wei*img_pre_fuse+fuse_out_conv_wei*pts_pre_fuse
